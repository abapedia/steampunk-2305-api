INTERFACE if_web_http_response
  ...
  TYPES            delete_cookie_at_client TYPE not_released.
  ...
  TYPES            get_status TYPE not_released.
  TYPES            get_text TYPE not_released.
  TYPES            server_cache_expire_rel TYPE not_released.
  TYPES            set_binary TYPE not_released.
  TYPES            set_compression TYPE not_released.
  ...
  TYPES            set_status TYPE not_released.
  TYPES            set_text TYPE not_released.
  TYPES            suppress_content_type TYPE not_released.
