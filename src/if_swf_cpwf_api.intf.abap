INTERFACE if_swf_cpwf_api
  ...
  TYPES cpwf_def_id_long TYPE c LENGTH 255.
  ...
  CONSTANTS cv_no_retention_time TYPE retention_time VALUE -1 ##NO_TEXT.
  ...
  METHODS update_retention_time
    ...
    RAISING
      cx_swf_cpwf_api.
  METHODS get_consumer_type DEFAULT IGNORE
    RETURNING
      VALUE(rv_consumer_type) TYPE swf_cpwf_consumer.
  METHODS start_workflow_ext DEFAULT IGNORE
    IMPORTING
      !iv_cp_workflow_def_id TYPE cpwf_def_id_long
      !iv_context TYPE context OPTIONAL
      !iv_retention_time TYPE retention_time
      !iv_callback_class TYPE callback_classname OPTIONAL
      !iv_do_commit TYPE abap_bool DEFAULT abap_false
    ...
    RAISING
      cx_swf_cpwf_api.
  METHODS get_workflow_id DEFAULT IGNORE
    IMPORTING
      !iv_cpwf_handle TYPE cpwf_handle
    RETURNING
      VALUE(rv_cp_workflow_inst_id) TYPE cpwf_id
    RAISING
      cx_swf_cpwf_api.
ENDINTERFACE.