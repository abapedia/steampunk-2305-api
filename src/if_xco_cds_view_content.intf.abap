INTERFACE if_xco_cds_view_content PUBLIC.
  TYPES:
    BEGIN OF ts_join,
      inner_join       TYPE REF TO if_xco_ddl_expr_data_source,
      left_outer_join  TYPE REF TO if_xco_ddl_expr_data_source,
      right_outer_join TYPE REF TO if_xco_ddl_expr_data_source,
    END OF ts_join,
    tt_join TYPE STANDARD TABLE OF ts_join WITH DEFAULT KEY,
  ...
  DATA:
    view       TYPE REF TO if_xco_cds_view READ-ONLY,
