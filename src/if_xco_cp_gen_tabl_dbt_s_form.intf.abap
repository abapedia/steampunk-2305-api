INTERFACE if_xco_cp_gen_tabl_dbt_s_form PUBLIC.
  TYPES:
    ...
    BEGIN OF ts_technical_settings,
      ...
      db_specific_properties TYPE REF TO if_xco_cp_gen_tabl_dbt_s_fo_td,
  ...
  METHODS:
    ...
    set_data_maintenance
      ...
      RETURNING
        VALUE(ro_me)        TYPE REF TO if_xco_cp_gen_tabl_dbt_s_form,
    set_inverted_hash_indicator
      IMPORTING
        iv_inverted_hash_indicator TYPE abap_bool DEFAULT abap_true
      RETURNING
        VALUE(ro_me)               TYPE REF TO if_xco_cp_gen_tabl_dbt_s_form,
    add_field
      IMPORTING
