INTERFACE if_iam_business_role
  ...
  TYPES:
    BEGIN OF tx_contract,
      ...
      get_uuid                    TYPE not_released,
      get_id                      TYPE not_released,
      get_description             TYPE not_released,
      get_long_text               TYPE not_released,
      get_template_id             TYPE not_released,
      set_description             TYPE not_released,
      set_long_text               TYPE not_released,
      set_group                   TYPE not_released,
      get_group                   TYPE not_released,
      get_admin_data              TYPE not_released,
      get_business_catalogs       TYPE not_released,
      add_business_catalog        TYPE not_released,
      remove_business_catalog     TYPE not_released,
      get_flp_spaces              TYPE not_released,
      add_flp_space               TYPE not_released,
      add_flp_space_from_template TYPE not_released,
      remove_flp_space            TYPE not_released,
      set_cflp_exposure           TYPE not_released,
      get_cflp_exposure           TYPE not_released,
      get_users                   TYPE not_released,
      add_user                    TYPE not_released,
      remove_user                 TYPE not_released,
      set_access_restriction      TYPE not_released,
      get_access_restriction      TYPE not_released,
      get_restrictions            TYPE not_released,
      create_restriction          TYPE not_released,
      update_restriction          TYPE not_released,
      remove_restriction          TYPE not_released,
    END OF tx_contract.
