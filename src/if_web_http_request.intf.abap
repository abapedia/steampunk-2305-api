INTERFACE if_web_http_request
  ...
  TYPES            add_multipart TYPE not_released.
  TYPES            append_binary TYPE not_released.
  TYPES            append_text TYPE not_released.
  TYPES            delete_header_field TYPE not_released.
  TYPES            from_xstring TYPE not_released.
  TYPES            get_binary TYPE not_released.
  TYPES            get_content_type TYPE not_released.
  TYPES            get_cookie TYPE not_released.
  TYPES            get_cookies TYPE not_released.
  TYPES            get_data_length TYPE not_released.
  TYPES            get_form_field TYPE not_released.
  TYPES            get_form_fields TYPE not_released.
  TYPES            get_form_fields_cs TYPE not_released.
  TYPES            get_form_field_cs TYPE not_released.
  TYPES            get_header_field TYPE not_released.
  TYPES            get_header_fields TYPE not_released.
  TYPES            get_last_error TYPE not_released.
  TYPES            get_method TYPE not_released.
  TYPES            get_multipart TYPE not_released.
  TYPES            get_text TYPE not_released.
  TYPES            num_multiparts TYPE not_released.
  TYPES            set_authorization_basic TYPE not_released.
  TYPES            set_authorization_bearer TYPE not_released.
  TYPES            set_binary TYPE not_released.
  TYPES            set_content_type TYPE not_released.
  TYPES            set_cookie TYPE not_released.
  TYPES            set_formfield_encoding TYPE not_released.
  TYPES            set_form_field TYPE not_released.
  TYPES            set_form_fields TYPE not_released.
  TYPES            set_header_field TYPE not_released.
  TYPES            set_header_fields TYPE not_released.
  TYPES            set_query TYPE not_released.
  TYPES            set_text TYPE not_released.
  TYPES            set_uri_path TYPE not_released.
  TYPES            set_version TYPE not_released.
  TYPES            to_xstring TYPE not_released.
