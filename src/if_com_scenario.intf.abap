INTERFACE if_com_scenario
  ...
  TYPES:
    BEGIN OF tx_contract,
      ...
      get_allowed_instance_type      TYPE not_released,
      is_inb_auth_none_supported     TYPE not_released,
      is_inb_auth_basic_supported    TYPE not_released,
      is_inb_auth_x509_supported     TYPE not_released,
      is_inb_auth_oauth2_supported   TYPE not_released,
      is_outb_auth_none_supported    TYPE not_released,
      is_outb_auth_basic_supported   TYPE not_released,
      is_outb_auth_x509_supported    TYPE not_released,
      is_outb_auth_oauth1_supported  TYPE not_released,
      is_outb_auth_oauth2_supported  TYPE not_released,
      get_outb_oauth2_client_profile TYPE not_released,
      get_outb_oauth2_target_path    TYPE not_released,
      get_outb_oauth2_granttype      TYPE not_released,
      is_outb_oa2_multi_cfg_allowed  TYPE not_released,
      get_created_by                 TYPE not_released,
      get_create_at                  TYPE not_released,
      get_change_by                  TYPE not_released,
      get_change_at                  TYPE not_released,
      get_properties                 TYPE not_released,
      get_inbound_services           TYPE not_released,
      get_outbound_services          TYPE not_released,
    END OF tx_contract.
