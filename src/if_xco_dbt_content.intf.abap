INTERFACE if_xco_dbt_content PUBLIC.
  TYPES:
    BEGIN OF ts_technical_settings,
      ...
      storage_type   TYPE REF TO cl_xco_dbt_storage_type,
      load_unit      TYPE REF TO cl_xco_dbt_load_unit,
  ...
  METHODS:
    ...
    get_inverted_hash_indicator
      IMPORTING
        io_origin                         TYPE REF TO cl_xco_tab_origin OPTIONAL
      RETURNING
        VALUE(rv_inverted_hash_indicator) TYPE abap_bool,
    get_includes
      IMPORTING
        io_origin          TYPE REF TO cl_xco_tab_origin OPTIONAL
      RETURNING
