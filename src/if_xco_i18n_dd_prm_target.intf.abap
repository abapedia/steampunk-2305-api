INTERFACE if_xco_i18n_dd_prm_target PUBLIC.
  ...
  METHODS:
    has_translation
      IMPORTING
        ...
        io_text_attribute         TYPE REF TO cl_xco_ddef_prm_text_attribute
      RETURNING
        VALUE(rv_has_translation) TYPE abap_bool,
    get_translations
      IMPORTING
        it_text_attributes     TYPE sxco_t_ddef_prm_text_attributs
      RETURNING
    ...
    set_translation
      IMPORTING
        io_language        TYPE REF TO if_xco_language
        it_texts           TYPE sxco_t_ddef_prm_texts
