INTERFACE if_xco_cp_ar_api_object PUBLIC.
  ...
  DATA:
    ...
    drty TYPE REF TO if_xco_ar_drty_object_factory READ-ONLY,
    dtel TYPE REF TO if_xco_ar_dtel_object_factory READ-ONLY,
    evtb TYPE REF TO if_xco_ar_evtb_object_factory READ-ONLY,
    ...
    ront TYPE REF TO if_xco_ar_ront_object_factory READ-ONLY,
    smbc TYPE REF TO if_xco_ar_smbc_object_factory READ-ONLY,
    srvb TYPE REF TO if_xco_ar_srvb_object_factory READ-ONLY,
    srvc TYPE REF TO if_xco_ar_srvc_object_factory READ-ONLY,
