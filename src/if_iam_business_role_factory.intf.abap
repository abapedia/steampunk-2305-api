INTERFACE if_iam_business_role_factory
  ...
  TYPES:
    BEGIN OF tx_contract,
      create_business_role       TYPE not_released,
      create_brole_from_template TYPE not_released,
      get_business_role          TYPE not_released,
      get_business_roles         TYPE not_released,
      get_business_role_by_id    TYPE not_released,
      query_business_roles       TYPE not_released,
    END OF tx_contract.
