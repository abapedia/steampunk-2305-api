INTERFACE if_xco_gen_bdef_s_fo_b_field PUBLIC.
  ...
  METHODS:
    ...
    set_mandatory_create
      ...
      RETURNING
        VALUE(ro_me)        TYPE REF TO if_xco_gen_bdef_s_fo_b_field,
    set_mandatory_execute
      IMPORTING
        iv_mandatory_execute TYPE abap_bool DEFAULT abap_true
      RETURNING
        VALUE(ro_me)         TYPE REF TO if_xco_gen_bdef_s_fo_b_field,
    set_read_only
      IMPORTING
    ...
    set_notrigger
      IMPORTING
        iv_notrigger TYPE abap_bool DEFAULT abap_true
      RETURNING
        VALUE(ro_me) TYPE REF TO if_xco_gen_bdef_s_fo_b_field,
    set_notrigger_warn
      IMPORTING
        iv_notrigger_warn TYPE abap_bool DEFAULT abap_true
      RETURNING
        VALUE(ro_me)      TYPE REF TO if_xco_gen_bdef_s_fo_b_field.
ENDINTERFACE.