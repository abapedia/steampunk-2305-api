INTERFACE if_xco_cp_ar_api_objects PUBLIC.
  DATA:
    ...
    evtb TYPE REF TO if_xco_cp_ar_evtb_oc_factory READ-ONLY,
    ...
    ront TYPE REF TO if_xco_cp_ar_ront_oc_factory READ-ONLY,
    smbc TYPE REF TO if_xco_cp_ar_smbc_oc_factory READ-ONLY,
    srvb TYPE REF TO if_xco_cp_ar_srvb_oc_factory READ-ONLY,
    srvc TYPE REF TO if_xco_cp_ar_srvc_oc_factory READ-ONLY,
